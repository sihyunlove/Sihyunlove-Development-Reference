...
web:
    ...
    restart: always
    hostname: 'sihyunlove.duckdns.org'
    ports:
    - '20080:80'
    - '20443:443'
    - '20022:22'
    volumes:
    - '/external/gitlab/config:/etc/gitlab'
    - '/external/gitlab/logs:/var/log/gitlab'
    - '/external/gitlab/data:/var/opt/gitlab'
...
# 도메인 입력(sihyunlove.duckdns.org), 이후 ____@sihyunlove.duckdns.org 형식으로 이메일을 받게 됨
...
``` yml
# 서버 주소 설정
external_url 'https://sihyunlove.duckdns.org'
...
gitlab_rails['smtp_user_name'] = "sihyunlove@zohomail.com"
gitlab_rails['smtp_password'] = "ZOapple#26"
gitlab_rails['smtp_domain'] = "smtp.zoho.com"
gitlab_rails['gitlab_email_from'] = 'sihyunlove@zohomail.com'
gitlab_rails['gitlab_email_reply_to'] = 'sihyunlove@zohomail.com'
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/sihyunlove.crt"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/sihyunlove.key"
